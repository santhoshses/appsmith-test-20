...
class ActionExecutionSolutionCEImplTest {
    ...
    public void testExecuteAction_withoutExecuteActionDTOPart_failsValidation() {
        final Mono<ActionExecutionResult> actionExecutionResultMono = actionExecutionSolution.executeAction(Flux.empty(), null, null,null);
    ...
    public void testExecuteAction_withMalformedExecuteActionDTO_failsValidation() {
        ...
        final Mono<ActionExecutionResult> actionExecutionResultMono = actionExecutionSolution.executeAction(partsFlux, null, null,null);
    ...
    public void testExecuteAPIWithUsualOrderingOfTheParts() {
        ...
        Mono<ActionExecutionResult> actionExecutionResultMono = executionSolutionSpy.executeAction(partsFlux, null, null,null);
    ...
    public void testParsePartsAndGetParamsFlux_withBlobIdentifiers_replacesValueInParam() {
        ...
        Mono<List<Param>> paramsListMono = actionExecutionSolution.parsePartsAndGetParamsFlux(partsFlux, atomicLong, executeActionDTO,null).collectList().cache();
