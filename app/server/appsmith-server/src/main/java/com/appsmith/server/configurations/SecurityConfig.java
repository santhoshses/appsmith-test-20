...
import com.appsmith.server.authentication.handlers.OidcLogoutSuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        ...
        return http
                ...
                .logoutSuccessHandler(new OidcLogoutSuccessHandler(objectMapper, analyticsService,reactiveClientRegistrationRepository))
                .and()
                .build();
    }
