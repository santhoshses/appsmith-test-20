...
const { enableOIDCProviderOAuth } = getAppsmithConfigs();
...
const Oidc_Auth: AdminConfigType = {
  ...
  subText:
    "Enable your organization to sign in with oidc SAML single sign-on (SSO).",
  canSave: true,
  isConnected: enableOIDCProviderOAuth,
  settings: [
    {
...
export const config: AdminConfigType = {
  ...
  canSave: false,
  children: [FormAuth, GoogleAuth, GithubAuth, Oidc_Auth],
  component: AuthMain,
};
