...
import { BASE_URL } from "./baseRoutes";
...
export const BUILDER_CUSTOM_PATH =
  BASE_URL + `/app/:customSlug(.*\-):pageId/edit`;
export const VIEWER_CUSTOM_PATH = BASE_URL + `/app/:customSlug(.*\-):pageId`;
...
export const ADMIN_SETTINGS_CATEGORY_PATH =
  BASE_URL + "/settings/:category/:selected?";
